...
if __name__ == "__main__":
    ResNet12 = resnet12(avg_pool=True, drop_rate=0.1, dropblock_size=5, num_classes=-1, no_trans=16, embd_size=64)
    ckpt = \
    torch.load('../../IE/save/Resnet12_IE/model_sleek-frost-16.pth')[
        "model"]
    model = torch.nn.DataParallel(ResNet12)
